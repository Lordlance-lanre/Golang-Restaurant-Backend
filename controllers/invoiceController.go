...
func GetInvoices() gin.HandlerFunc{
	return func(c *gin.Context){
		...
		if err := result.All(ctx, &allInvoices); err != nil{
			msg := "Error occured while fetching all invoices"
...
func CreateInvoice() gin.HandlerFunc{
	return func(c *gin.Context){
		...
		if err != nil{
			msg := "Error occured while creating the invoice"
			c.JSON(http.StatusInternalServerError, gin.H{"error": msg})
			return
		}
		defer cancel()
...
func DeleteInvoice() gin.HandlerFunc{
	return func(c *gin.Context){
		...
		if err != nil {
			c.JSON(http.StatusInternalServerError, gin.H{"error": "Error occurred while deleting invoice: " + err.Error()})
			return
		}
